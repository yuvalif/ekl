...
%disp('\n loading files: husbands_1.out');
%husbands_HS = load('husbands_1.out');
%disp('\n loading files: husbands_2.out');
%husbands_SC = load('husbands_2.out');
%disp('\n loading files: husbands_3.out');
%husbands_CG = load('husbands_3.out');
...
%emp_mrate_child_wage_d= load('emp_mrate_child_wage_d.out');
